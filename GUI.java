...
public class GUI extends JFrame{
	...
	public void findDir(){		
		int i = JOptionPane.showConfirmDialog(null,
				"<html><body style ='width: 250px'>You have not chosen a default directory yet. In order to continue and run this software, "
					...
					"Spam Detection Software",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE,null);
		if(i==0) {
			...
			JOptionPane.showMessageDialog(null,"You cannot run this software until a directory is set.  Try again when you want to set one!",
					"Spam Detection Software",JOptionPane.WARNING_MESSAGE);
		}
	}
	public void addSpam() throws IOException {
		...
		if(i==0) {
			...
			JOptionPane.showMessageDialog(null, "Thank you for using this Spam Detection Software!","Spam Detection Software",JOptionPane.INFORMATION_MESSAGE);
		}
	}
