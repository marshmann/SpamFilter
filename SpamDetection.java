//Code authored by Nicholas Marshman

//TODO: add comments to the code, i'm like a heretic with how barren it is down there!
/*
 The current code uses naive bayes to calculate the probability a word in an email is a "spam word" or not.
 Normally in naive bayes you would take the product of all the probabilities to make a prediction on which is more likely, however
 in testing this AND in testing of the emoji prediction program that used the same algorithm, it seems like taking the sum works more often (for some reason).
*/
...
public class SpamDetection {
	...
	private static void runTest(ArrayList<Data> data) throws IOException{
		...
		for(int i = (int)size; i < labels.size(); i++){
			String path = "C:\\Users\\Nicholas\\eclipse-workspace\\SpamDetection\\src\\CSDMC2010_SPAM\\TRAINING\\";
	...
	private static ArrayList<Character> readLabels() throws IOException{
		String path = "C:\\Users\\Nicholas\\eclipse-workspace\\SpamDetection\\src\\CSDMC2010_SPAM\\SPAMTrain.txt";
		String line = "";
	...
	public static ArrayList<Data> readTxt() throws IOException {
		String path = "C:\\Users\\Nicholas\\eclipse-workspace\\SpamDetection\\spam.txt";
		String line = "";
		BufferedReader br = new BufferedReader(new FileReader(path));
